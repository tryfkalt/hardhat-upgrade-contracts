...
async function main() {
  ...
  // we get the BoxV2 abi but the address of the transparent proxy 
  // this way ethers knows that it's going to call all the functions of the transparent proxy
  // but the proxyBox is going to have the abi of BoxV2
